    ...
    public class ArcadeVehicleController : MonoBehaviour {
        ...
        private void Update() {
            ...
            if(nosTime){
                ...
                audioManager.PlayOneShotMusic(Sounds.SoundType.Booster);
            }else{
                currentMaxSpeed = MaxSpeed;
                audioManager.StopAudio(Sounds.SoundType.Booster);
            }
        ...
        public void AudioSetup() {
            engineSound.volume = audioManager.GetSfxVolumeAmount();
            SkidSound.volume = audioManager.GetSfxVolumeAmount();
            boosterSound.volume = audioManager.GetSfxVolumeAmount();
        ...
        public float GetVelocity(bool isKmph = true){
            float returnSpeed = currentVelocity;
            if(!isKmph){
                returnSpeed = currentVelocity * 0.6f;
            }
            return returnSpeed;
        }
